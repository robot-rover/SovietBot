...
public class Perms extends TableImpl<PermsRecord> {
    ...
    private static final long serialVersionUID = -2077851774;
     ...
     */
    public final TableField<PermsRecord, String> GUILDID = createField("guildid", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>perms.userid</code>.
     */
    public final TableField<PermsRecord, String> USERID = createField("userid", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PERMSINDEX);
    }
