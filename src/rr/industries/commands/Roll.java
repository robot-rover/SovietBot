...
public class Roll implements Command {
    @SubCommand(name = "", Syntax = {
            ...
            @Syntax(helpText = "Rolls a number 1-#", args = {@ArgSet(arg = Arguments.NUMBER)}),
            @Syntax(helpText = "Rolls the dice RP style. Rolls a number 1-Y, X times", args = {@ArgSet(arg = Arguments.DND)})
    })
